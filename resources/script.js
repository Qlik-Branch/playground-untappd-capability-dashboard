...
Playground.authenticate(config.apiKey, true).then(function(ticket){
  config.ticket = ticket;
    ...
    require(['js/qlik'], function(qlik) {
      ...
      //using the capability api we create a new 'qsSimpleKPI' object
      app.visualization.create('qsSimpleKPI', [], dbrDef).then(function(viz){
        viz.show("distinctBreweries");
      });
